...
print_test_header "ClaudeBox Docker Build/Install - Bash 3.2"
...
print_test_header "ClaudeBox Docker Build/Install - Bash 4.0"
...
print_test_header "ClaudeBox Docker Build/Install - Bash 5.0"
...
docker rmi bash:5.3 >/dev/null 2>&1 || true
